...
if [ "${choice}" != '0' ]; then
  echo "Ok. You're on a VirtualBox VM."
  echo "Wait till the VM setup is complete..."
   sleep 1
   Vmbox_setup
else
  echo "Skipping... You're on a real machine."
  sleep 1
